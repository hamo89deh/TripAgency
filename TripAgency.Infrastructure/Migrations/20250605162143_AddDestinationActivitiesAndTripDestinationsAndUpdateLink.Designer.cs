...
namespace TripAgency.Infrastructure.Migrations
{
    ...
    [Migration("20250605162143_AddDestinationActivitiesAndTripDestinationsAndUpdateLink")]
    partial class AddDestinationActivitiesAndTripDestinationsAndUpdateLink
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TripAgency.Data.Entities.PackageTripDestinationActivity", b =>
                {
                    ...
                    b.HasIndex("DestinationActivityId");
            ...
            modelBuilder.Entity("TripAgency.Data.Entities.PackageTripDestination", b =>
                {
                    ...
                    b.HasOne("TripAgency.Data.Entities.TripDestination", "TripDestination")
                        .WithMany("PackageTripDestinations")
            ...
            modelBuilder.Entity("TripAgency.Data.Entities.PackageTripDestinationActivity", b =>
                {
                    b.HasOne("TripAgency.Data.Entities.DestinationActivity", "DestinationActivity")
                        .WithMany("PackageTripDestinationActivities")
                        .HasForeignKey("DestinationActivityId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("DestinationActivity");
